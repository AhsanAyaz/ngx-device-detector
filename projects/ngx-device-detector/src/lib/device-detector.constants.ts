...
class DeviceDetectorParser {
  ...
  OS_VERSIONS: any = {
    ...
    iOS: 'iOS',
    ANDROID_9: 'android-9',
    UNKNOWN: this.GENERAL.UKNOWN.toLowerCase(),
  };
  ...
  OS_VERSIONS_RE: any = Object.keys(this.OS_VERSIONS_RE_MAP).reduce((obj, key: string) => {
    obj[key] = this.OS_VERSIONS_RE_MAP[key];
    return obj;
  }, {});

  BROWSER_VERSIONS_RE: any = Object.keys(this.BROWSER_VERSIONS_RE_MAP).reduce((obj, key: string) => {
    obj[this.BROWSERS[key]] = this.BROWSER_VERSIONS_RE_MAP[key];
    return obj;
  }, {});
}
