...
## 1.3.12
- Fixed [#113 - The mobile device is determined to be a tablet](https://github.com/KoderLabs/ngx-device-detector/issues/113). Thanks to [Syed Saad Qamar](https://github.com/SaadQamar01)
