...
exports.DEVICES_RE = __assign({}, exports.MOBILES_RE, exports.TABLETS_RE, { FIREFOX_OS: { and: [/\bFirefox\b/, /\bMobile\b/] }, CHROME_BOOK: /\bCrOS\b/, PS4: /\bMozilla\/5.0 \(PlayStation 4\b/, CHROMECAST: /\bCrKey\b/, APPLE_TV: /^iTunes-AppleTV\/4.1$/, GOOGLE_TV: /\bGoogleTV\b/, Tesla: /Tesla\/([0-9]{4}.[0-9]{1,2}.?[0-9]{0,2}.?[0-9]{0,2})-(.{7})/ });
exports.OS_VERSIONS_RE_MAP = {
    WINDOWS_3_11: /Win16/,
...
exports.BROWSER_VERSIONS_RE_MAP = {
...
exports.OS_VERSIONS_RE = Object.keys(exports.OS_VERSIONS_RE_MAP).reduce(function (obj, key) {
    obj[key] = exports.OS_VERSIONS_RE_MAP[key];
    return obj;
}, {});
exports.BROWSER_VERSIONS_RE = Object.keys(exports.BROWSER_VERSIONS_RE_MAP).reduce(function (obj, key) {
    obj[exports.BROWSERS[key]] = exports.BROWSER_VERSIONS_RE_MAP[key];
    return obj;
}, {});
//# sourceMappingURL=device-detector.constants.js.map